...
public class ApplicationSecurityConfig {
	...
	{	http.authorizeHttpRequests((authz)->authz
		.requestMatchers("/prodStock/AddProd").hasRole("USER")
		.requestMatchers("/prodStock/FetchAllProducts").hasRole("USER")
		.requestMatchers("/prodStock/FetchById").hasRole("USER")
		.requestMatchers("/prodStock/update").hasRole("USER")
